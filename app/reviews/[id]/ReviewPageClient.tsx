...
import { ArrowLeft, Award, Check, Clock, ExternalLink, Flag, Share2, Star, ThumbsUp, User } from "lucide-react"
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-4 border-t border-border/50">
                            <div className="flex items-center gap-6">
                                ...
                                <div className="flex items-center gap-1 text-sm">
                                    ...
                                    <span>{parseFloat(review.weighted_vote_score).toFixed(2)} score</span>
                                </div>
                            </div>
