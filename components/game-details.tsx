...
export function GameDetails({ gameId }: GameDetailsProps) {
  ...
  const navigateMedia = (direction: 'left' | 'right') => {
    ...
    // Scroll the carousel to make the new current item visible
    if (carouselRef.current) {
      const itemWidth = 320 + 8 // width + gap
      const targetScroll = newIndex * itemWidth - (carouselRef.current.clientWidth / 2) + (itemWidth / 2)
      const clampedScroll = Math.max(0, Math.min(targetScroll, carouselRef.current.scrollWidth - carouselRef.current.clientWidth))
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <Skeleton className="h-5 w-full mb-2 bg-card/50" />
            <Skeleton className="h-5 w-5/6 mb-4 bg-card/50" />
            <div className="flex gap-2 mb-6">
              <Skeleton className="h-6 w-16 bg-card/50" />
              <Skeleton className="h-6 w-20 bg-card/50" />
              <Skeleton className="h-6 w-14 bg-card/50" />
            </div>
            <div className="flex gap-3 mb-8">
              <Skeleton className="h-12 w-32 bg-card/50" />
              <Skeleton className="h-12 w-36 bg-card/50" />
              <Skeleton className="h-12 w-24 bg-card/50" />
            </div>

            {/* Media display skeleton */}
            <Skeleton className="h-96 w-full mb-4 bg-card/50" />

            {/* Media carousel skeleton */}
            <div className="flex gap-2 mb-8 overflow-hidden">
              <Skeleton className="h-20 w-80 flex-shrink-0 bg-card/50" />
              <Skeleton className="h-20 w-80 flex-shrink-0 bg-card/50" />
              <Skeleton className="h-20 w-80 flex-shrink-0 bg-card/50" />
            </div>

            {/* Game stats card skeleton */}
            <div className="border rounded-lg p-6 mb-8 bg-card/50">
              <Skeleton className="h-6 w-40 mb-4 bg-card/30" />
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center">
                  <Skeleton className="h-5 w-5 mx-auto mb-2 bg-card/30" />
                  <Skeleton className="h-8 w-12 mx-auto mb-1 bg-card/30" />
                  <Skeleton className="h-4 w-16 mx-auto bg-card/30" />
                </div>
                <div className="text-center">
                  <Skeleton className="h-5 w-5 mx-auto mb-2 bg-card/30" />
                  <Skeleton className="h-8 w-12 mx-auto mb-1 bg-card/30" />
          ...
          <div>
            ...
            <div className="border rounded-lg p-6 mb-6 bg-card/50">
              <div className="text-center mb-4">
                <Skeleton className="h-8 w-20 mx-auto mb-2 bg-card/30" />
                <Skeleton className="h-12 w-full mb-3 bg-card/30" />
                <Skeleton className="h-10 w-full bg-card/30" />
              </div>
              <div className="border-t my-4 bg-card/30" />
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  <Skeleton className="h-4 w-20 bg-card/30" />
                  <Skeleton className="h-4 w-16 bg-card/30" />
                </div>
                <div className="flex justify-between">
                  <Skeleton className="h-4 w-20 bg-card/30" />
                  <Skeleton className="h-4 w-18 bg-card/30" />
                </div>
              </div>
            </div>
            ...
            <div className="border rounded-lg p-6 bg-card/50">
              <Skeleton className="h-6 w-36 mb-2 bg-card/30" />
              <Skeleton className="h-4 w-48 mb-4 bg-card/30" />
              <div className="space-y-3 mb-4">
                <div className="flex items-center gap-3">
                  <Skeleton className="h-4 w-16 bg-card/30" />
                  <Skeleton className="h-4 flex-1 bg-card/30" />
                  <Skeleton className="h-4 w-10 bg-card/30" />
                </div>
                <div className="flex items-center gap-3">
                  <Skeleton className="h-4 w-16 bg-card/30" />
                  <Skeleton className="h-4 flex-1 bg-card/30" />
              ...
              <div className="space-y-2">
                {Array.from({ length: 5 }).map((_, i) => (
                  <div key={i} className="flex items-center gap-2">
                    <Skeleton className="h-4 w-12 bg-card/30" />
                    <Skeleton className="h-4 flex-1 bg-card/30" />
                    <Skeleton className="h-4 w-8 bg-card/30" />
                  </div>
                ))}
              </div>
            </div>
