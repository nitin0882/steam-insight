...
import { AlertCircle, Award, Clock, ExternalLink, Flag, ThumbsDown, ThumbsUp, User } from "lucide-react"
            ...
            <section className="py-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="text-muted-foreground mb-4">{error || "Something went wrong while fetching reviews."}</p>
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 pt-2 border-t border-border/50">
                                        <div className="flex items-center gap-2 sm:gap-4">
                                            <Button variant="ghost" size="sm" className="text-muted-foreground hover:text-foreground h-8 px-2">
                                                ...
                                                <span className="hidden xs:inline">Helpful</span> ({review.votes_up})
                                            </Button>
                                            {review.votes_funny > 0 && (
                                                <Button variant="ghost" size="sm" className="text-muted-foreground hover:text-foreground h-8 px-2">
                                                    <ThumbsDown className="w-3 h-3 mr-1" />
                                                    <span className="hidden xs:inline">Funny</span> ({review.votes_funny})
                                                </Button>
                                            )}
                                        </div>
